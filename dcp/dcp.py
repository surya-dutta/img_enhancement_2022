...
if __name__ == '__main__':
    pass
filenames = glob(r"C:\Users\vsidd\Desktop\python\CAPSTONE\ACTUAL code\Input Images\*.jpg")
filenames.sort()
...
for img in images:
    ...
    cv2.imwrite("DCPIMG"+str(i)+".jpg" ,np.uint8(transmission * 255))
    cv2.imwrite("DCP"+str(i)+".jpg" ,sceneRadiance)
    i+=1
